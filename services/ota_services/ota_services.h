...
#define OTA_ROOT_CA_CERTIFICATE "-----BEGIN CERTIFICATE-----\n" \
...
typedef enum {
    OTA_ERROR_UPDATE_UNKNOWN = 40,
    OTA_ERROR_DOWNLOAD_FAILED_LOW_BATTERY,
    OTA_ERROR_DOWNLOAD_INSUFFICIENT_FLASH,
    OTA_ERROR_DOWNLOAD_INSUFFICIENT_ALLOCATION_RAM,
    OTA_ERROR_DOWNLOAD_REQUEST_TIMEOUT,
    OTA_ERROR_DOWNLOAD_DATA_VERIFICATION_FAILED,
    OTA_ERROR_UPDATE_LOW_BATTERY,
    OTA_ERROR_UPDATE_INSUFFICIENT_ALLOCATION_RAM,
    OTA_ERROR_UPDATE_VERSION_ERROR,
    OTA_ERROR_UPDATE_HMAC_VERIFICATION_FAILED,
    OTA_ERROR_UPDATE_GATEWAY_BUSY,
} ota_err_code_t;
